  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        Address to allow: <input type="text" name="kycAddress" value={this.state.kycAddress} onChange={this.inputChangeHandler} />
        <button type="button" onClick={this.kycSubmitHandler}>Add Address to Whitelist</button>

        <h2>Buy Covid Tokens</h2>
        <p>Send Ether to this address: {this.state.tokenSaleAddress}</p>

        <p>You have: {this.state.userTokens}</p>
        <button type="button" onClick={this.buyTokenHandler}>Buy more tokens</button>
      </div>
    );
  }
}
